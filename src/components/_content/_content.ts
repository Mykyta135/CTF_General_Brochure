...
export const sellingPointsExplanation = {
  generalPartner: [
    ...
    },
    {
      ...
      details:
        "Формат Jeopardy передбачає, що командам надають набір незалежних завдань різних категорій та складності. Ми пропонуємо вам самостійно розробити від 2 до 4 завдань. Завдання можуть бути різних категорій – forensic, web, crypto, misc, pwn, reverse. Варіантом завдань може бути Ваші тестові завдання на співбесіді. Оцінювання завдань ми встановлюємо самостійно, відносно складності інших наявних завдань. Завдання повинне бути виконане студентом у межах 30 хв.",
    }, {
